<nav x-data="{ open: false }" class="nav-menu bg-white dark:bg-gray-800">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <!-- Navigation Links -->
                <div class="nav-links hidden space-x-8 sm:-my-px sm:ms-5 sm:flex">
            ...
            <div class="flex items-center">
                ...
                <!-- Button for site -->
                <div class="nav-links nav-links__adminButton hidden space-x-8 sm:-my-px sm:ms-6 sm:flex">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="nav-links nav-links__hamburger pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('categoryIndex')" :active="request()->routeIs('categoryIndex')">
                {{ __('Category') }}
            </x-responsive-nav-link>
        </div>

        <div class="nav-links nav-links__hamburger pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('adminProductIndex')" :active="request()->routeIs('adminProductIndex')">
                {{ __('Products') }}
            </x-responsive-nav-link>
        </div>

        <div class="nav-links nav-links__hamburger pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('adminReviewIndex')" :active="request()->routeIs('adminReviewIndex')">
                {{ __('Reviews') }}
            </x-responsive-nav-link>
        </div>

        <div class="nav-links nav-links__hamburger pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('adminOrderIndex')" :active="request()->routeIs('adminOrderIndex')">
                {{ __('Orders') }}
            </x-responsive-nav-link>
        </div>
        ...
        <!-- Button for site -->
        <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
            <x-responsive-nav-link href="{{ route('productIndex') }}">Сайт</x-responsive-nav-link>
        </div>
    </div>
</nav>