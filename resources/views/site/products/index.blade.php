        ...
        <nav class="filter-sort">
            <form action="{{ route('productIndex') }}" method="get" class="search-block"> 
                <div class="search">
                    ...
                    <div class="search-filter__block">
                        <svg class="filters-button" id="filters-button" width="39px" height="39.5px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="filter-sort__block active">
                ...
                <form action="{{ route('productIndex') }}" method="get" class="filter-block">
                    ...
                    <label>
                        <span>Категорії</span>
                        <select name="category" id="filter-block__category">
                        ...
                        <input type="hidden" id="categoryIdsJson" value="{{ $categoryIdsJson }}">
                    </label>
                    <label>
                        <span>Розміри</span>
